...
namespace SignalRPro.Extensions
{
    public static class DbContextExtensions
    {
        ...
        (this DbContext dbContext, IQueryable iQueryable) where TEntity : class
        {
        ...
        (this DbContext dbContext, IQueryable query) where TEntity : class
        {
